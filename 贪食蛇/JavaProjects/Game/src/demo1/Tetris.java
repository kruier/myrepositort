...
public class Tetris extends JPanel {
    ...
    static {
        try {
            backImage = ImageIO.read(new File("JavaProjects/images/background.png"));
            I = ImageIO.read(new File("JavaProjects/images/I.png"));
            J = ImageIO.read(new File("JavaProjects/images/J.png"));
            L = ImageIO.read(new File("JavaProjects/images/L.png"));
            O = ImageIO.read(new File("JavaProjects/images/O.png"));
            S = ImageIO.read(new File("JavaProjects/images/S.png"));
            T = ImageIO.read(new File("JavaProjects/images/T.png"));
            Z = ImageIO.read(new File("JavaProjects/images/Z.png"));
